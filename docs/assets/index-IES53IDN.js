(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{title:`Fenster, Turen & Montage`,text:`Einbau, Austausch und saubere Nacharbeiten bei Fenstern, Turen, Zargen, Regalen und passgenauen Bauteilen.`},{title:`Wande, Boden & Ausbau`,text:`Ausbesserung von Wanden, Estrich, Rigips, Paneelen und allen sichtbaren Oberflachen im Innenbereich.`},{title:`Fliesen & Belage`,text:`Fliesen, Platten, Laminat, Linoleum, PVC und Kunststoffboden mit sauberem Abschluss und robustem Finish.`},{title:`Schimmel & Wasserschaden`,text:`Beseitigung von Feuchteschaden, Schimmelspuren und den daraus entstehenden Schadenbildern.`},{title:`Reparatur & Wartung`,text:`Schlosser, Schalter, Dichtungen, Wasserhahne, Siphons, Beschlage und viele kleine Arbeiten aus einer Hand.`},{title:`Mobel, Kuche & Details`,text:`Aufbau, Anpassung, Wandmontage, Silikonfugen, Duschkabinen und die Arbeiten, die am Ende den Unterschied machen.`}],t=[`Renovierungs- und Ausbesserungsarbeiten aller Art`,`Direkter Kontakt mit Arsen Movsisyan`,`Echte Referenzen aus der bisherigen Arbeit`,`Besichtigungstermin unkompliziert telefonisch vereinbaren`],n=[{eyebrow:`Schimmel & Feuchte`,title:`Wasserschaden saniert`,text:`Vorher sichtbarer Schaden, nachher wieder sauber aufgebaut und optisch beruhigt.`,before:`/images/projects/water-damage-before.webp`,after:`/images/projects/water-damage-after.webp`},{eyebrow:`Umbau & Statik`,title:`Tragende Wand durch Stahltrager ersetzt`,text:`Ein starker Eingriff, sauber umgesetzt und anschliessend wieder ordentlich in den Raum integriert.`,before:`/images/projects/steel-beam-before.webp`,after:`/images/projects/steel-beam-after.webp`},{eyebrow:`Bad & Ausbau`,title:`Duschkabine neu montiert`,text:`Ein klassisches Vorher-Nachher Beispiel fur den Unterschied zwischen improvisiert und sauber fertig.`,before:`/images/projects/shower-before.webp`,after:`/images/projects/shower-after.webp`}],r=[{title:`Fliesenverlegung`,image:`/images/projects/tiles-after.webp`},{title:`Holzfenster erneuert`,image:`/images/projects/window-after.webp`},{title:`Schimmel beseitigt`,image:`/images/projects/mold-after.webp`}];document.querySelector(`#app`).innerHTML=`
        ...
        <div class="services-grid">
          ${e.map((e,t)=>`
                <article class="service-card">
                  <span class="service-index">0${t+1}</span>
                  <h3>${e.title}</h3>
                  <p>${e.text}</p>
                </article>
              `).join(``)}
          ...
          ${n.map(e=>`
                <article class="project-card">
                  <div class="project-copy">
                    <p class="project-eyebrow">${e.eyebrow}</p>
                    <h3>${e.title}</h3>
                    <p>${e.text}</p>
                  </div>
                  <div class="before-after">
                    <figure>
                      <img src="${e.before}" alt="${e.title} vorher" loading="lazy" />
                      <figcaption>Vorher</figcaption>
                    </figure>
                    <figure>
                      <img src="${e.after}" alt="${e.title} nachher" loading="lazy" />
